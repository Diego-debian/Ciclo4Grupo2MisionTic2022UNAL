...
from typing import TypeVar, List, get_origin, get_args, Generic
import json
...
class InterfazRepositorio(Generic[T]):
    ...
    #Primero funcion convertir los valores de la solicitud
    #en una lista
    def getValuesDBRefFromList(self, theList):
        newList = []
        laColeccion = self.db[theList[0]._id.collection] #La colección creada
        for item in theList:
    ...
    #Segundo función me clasifica si es lista, diccionario
    # y los convierte en el objeto correcto
    ...
    #Función que le da formato a mi lista general
    ...
    #Clasificar la solicitud y desmenuzarla
    ...
    #Función save que guarda cualquier cosa
